...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#000000', borderWidth: 1, borderColor: '#17181B', borderRadius: 26, padding: 16, gap: 12 },
  cardTop: { flexDirection: 'row', justifyContent: 'space-between' },
  right: { alignItems: 'flex-end' },
  plate: { color: '#F1F1F1', fontSize: 18, fontWeight: '700' },
  mono: { fontVariant: ['tabular-nums'] },
  muted: { color: '#63676C', fontSize: 13 },
  route: { flexDirection: 'row', gap: 12 },
  rail: { alignItems: 'center', width: 18, paddingVertical: 4 },
  railFill: { width: 2, backgroundColor: '#FCEE58' },
  railRest: { width: 2, backgroundColor: '#636A71' },
  truck: { fontSize: 14, lineHeight: 18 },
  endDot: { width: 7, height: 7, borderRadius: 3.5, backgroundColor: '#636A71' },
  endDotDone: { backgroundColor: '#FCEE58' },
  legs: { flex: 1 },
  legLabel: { color: '#3A3D40', fontSize: 11 },
  legValue: { color: '#5C5C5C', fontSize: 15 },
  legSpacer: { marginTop: 10 },
  cardBottom: { alignItems: 'flex-end' },
  driver: { color: '#C8C8C8', fontSize: 15, fontWeight: '700' },
